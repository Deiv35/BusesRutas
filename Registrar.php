...
<div class="container">
    ...
    <?php if (!empty($mensaje)): ?>
        <div class="message <?php echo strpos($mensaje, 'exitoso') !== false ? 'success' : 'error'; ?>">
    ...
    <form method="post">
        ...
        <div class="password-box">
            ...
            <button type="button" class="btn btn-secondary" id="btnToggle" onclick="togglePassword()">Ver</button>
        </div>
